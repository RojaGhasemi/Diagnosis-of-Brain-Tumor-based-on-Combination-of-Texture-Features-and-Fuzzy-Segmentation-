%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  ACO and VPSO source codes version 1.0                           %
%                                                                   %
...
function [gBest,gBestScore,ConvergenceCurve]=ACO(noP,Max_iteration,ACO_num,CostFunction,noV)
...
for l=1:Max_iteration
    ...
    for i=1:size(Position,1)
        for j=1:size(Position,2) 
            ...
            if ACO_num<=4 %S-shaped transfer functions
            ...
            if ACO_num>4 && ACO_num<=8 %V-shaped transfer functions
...
%     save('gBestScore.mat','gBestScore');
    save('pBest.mat','pBest')
%     save('gBest.mat','gBest')
%      save('ConvergenceCurve.mat','ConvergenceCurve')
